...
The documentation for these example designs is hosted at <https://sfp28-mrmac.ethernetfmc.com>
...
only wish to view the documentation, then please view it [here](https://sfp28-mrmac.ethernetfmc.com).
...
(`docs/source/images/versal-mrmac-quad-sfp28-block-diagram.png`) is generated from the Python/matplotlib
